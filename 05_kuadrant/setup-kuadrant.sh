...
echo ">>> 5.1 建立 kuadrant-system 與 Kuadrant CR"
...
echo ">>> 5.2 等待 authorino-authorino-authorization Service"
...
# 等 service-ca 簽出憑證
echo ">>> 5.3 等待 authorino-server-cert Secret"
...
echo ">>> 5.5 設定 Authorino deployment 環境變數"
